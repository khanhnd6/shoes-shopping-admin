...
const Pagination = ({
  ...
  const totalPages = totalItems == null ? Math.ceil(products.length / itemsPerPage) : Math.ceil(totalItems / itemsPerPage);
  ...
  }, [currentPage, products, totalItems])

  // useEffect(()=>{
  //   if(type == "CALLAPI") {
  //     handleChangePageNum(currentPage, itemsPerPage)
  //   }
